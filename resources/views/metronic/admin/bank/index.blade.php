        ...
        <div class="col-md-12">
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    ...
                    <a href="{{route('bank_create')}}" title="New Bank" class="panel-title-btn btn btn-icon waves-effect waves-light btn-success btn-back pull-right" > <i class="ion-plus-circled"></i> </a>
                </div>
                <div class="portlet-body">
                    <div class="">
                        @include('layouts.alert')
                        <table class="table table-striped table-hover"  id="bank">
                        <thead>
                            <tr>
                                <th>
                                    #
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $bank['name'] }}</td>
                                <td>
                                    <span class="label label-sm label-{{ $bank['active_status'] == 1 ? 'success' : 'danger' }} ">
                                    {{ $bank['active_status'] == 1 ? 'Active' : 'Inactive' }}
                                    </span>
                                </td>
                                <td>
                                    <a href="{{route('bank_edit',$bank['id'])}}" class="btn btn-icon-only purple" title="Edit">
