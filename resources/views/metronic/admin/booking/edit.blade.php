...
@section('content')
    ...
    <div class="page-head">
        ...
        <div class="page-title">
            <h1>Ticket Sales <small>Edit</small></h1>
        </div>
        <!-- END PAGE TITLE -->
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="radio-list">
                                        ...
                                        <input type="radio" name="seat_class" value="1" {{ $booking['seat_class'] == 1 ? 'checked' : '' }}  > Business Class </label>
                                        <label class="radio-inline">
                                        <input type="radio" name="seat_class" value="2" {{ $booking['seat_class'] == 2 ? 'checked' : '' }}  > Economy Class </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 {{ $errors->has('travel_date') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        <i class="fa fa-calendar "></i>
                                        <input type="text" class="form-control datepicker" name="travel_date" placeholder="dd-mm-yyyy" value="{{ old('travel_date') ? old('travel_date') : $booking['travel_date'] }}"  >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 {{ $errors->has('return_date') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        <i class="fa fa-calendar "></i>
                                        <input type="text" class="form-control datepicker" name="return_date" placeholder="dd-mm-yyyy" value="{{ old('return_date') ? old('return_date') : $booking['return_date'] }}"  >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 {{ $errors->has('currency_id') ? 'has-error' : '' }}">
                                    <select class="form-control select2" name="currency_id" id="currency">
                                        ...
                                        <option value="{{ $currencyId }}" {{ $booking['currency_id'] == $currencyId ? 'selected' : '' }} >
                                            {{ $currencyName }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 {{ $errors->has('sector_id') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        <i class="fa fa-group"></i>
                                        <textarea class="form-control" name="sector_id" placeholder="Booking Reference" >{{ old('sector_id') ? old('sector_id') : $booking['sector_id'] }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2 {{ $errors->has('ait_percentage') ? 'has-error' : '' }}">
                                    <div>
                                        <input type="text" class="form-control" name="ait_percentage" value="{{ old('ait_percentage') ? old('ait_percentage') : $booking['ait_percentage'] }}" placeholder="AIT" >
                                ...
                                <div class="col-md-4 {{ $errors->has('ait') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        ...
                                        <input type="text" class="form-control" name="ait" value="{{ old('ait') ? old('ait') : $booking['ait'] }}" placeholder="AIT" >
                                        @if ($errors->has('ait'))
                                        <span class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                        <input type="radio" name="pax_type" value="1" {{ $booking['pax_type'] == 1 ? 'checked' : '' }}  > Adult </label>
                                        <label class="radio-inline">
                                        <input type="radio" name="pax_type" value="2" {{ $booking['pax_type'] == 2 ? 'checked' : '' }}  > Child </label>
                                        <label class="radio-inline">
                                        <input type="radio" name="pax_type" value="3" {{ $booking['pax_type'] == 3 ? 'checked' : '' }}  > Infant </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
