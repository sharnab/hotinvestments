                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 {{ $errors->has('ait') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        ...
                                        <input type="text" class="form-control" name="ait" value="{{ old('ait') ? old('ait') : 0 }}" placeholder="AIT" readonly>
                                        @if ($errors->has('ait'))
                                        <span class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 {{ $errors->has('total_fare') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        <i class="fa fa-money"></i>
                                        <input type="text" class="form-control" name="total_fare" value="{{ old('total_fare') }}" placeholder="Total Fare" >
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label required">Discount Amount/Percentage</label>
                                <div class="col-md-6 {{ $errors->has('discount_amount') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        <i class="fa fa-money"></i>
                                        <input type="text" class="form-control" name="discount_amount" value="{{ old('discount_amount') }}" placeholder="Discount Amount/Percentage" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 {{ $errors->has('reissue_or_refund_charged') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        <i class="fa fa-credit-card"></i>
                                        <input type="text" class="form-control" name="reissue_or_refund_charged" value="{{ old('reissue_or_refund_charged') }}" placeholder="Reissue/Refund Charged" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 {{ $errors->has('customer_charged') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        <i class="fa fa-money"></i>
                                        <input type="text" class="form-control" name="customer_charged" value="{{ old('customer_charged') }}" placeholder="Customer Charged" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 {{ $errors->has('payable_amount') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        <i class="fa fa-money"></i>
                                        <input type="text" class="form-control" name="payable_amount" value="{{ old('payable_amount') }}" placeholder="Payable Amount" readonly >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 {{ $errors->has('actual_payable_amount') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        <i class="fa fa-credit-card"></i>
                                        <input type="text" class="form-control" name="actual_payable_amount" value="{{ old('actual_payable_amount') }}" placeholder="Actual Payable Amount" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 {{ $errors->has('paid_amount') ? 'has-error' : '' }}">
                                    <div class="input-icon">
                                        <i class="fa fa-money"></i>
                                        <input type="text" class="form-control" name="paid_amount" value="{{ old('paid_amount') }}" placeholder="Paid Amount" required>
