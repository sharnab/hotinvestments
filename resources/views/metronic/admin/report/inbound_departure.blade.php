                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <table class="table-bordered">
                                    ...
                                    <tr class="bordered-tr">
                                        <td class="table-data bordered-td" style="text-align: center;">{{ date('d', strtotime($data->travel_date)) }}</td>
                                        <td class="table-data bordered-td" style="text-align: center;">{{ date('m', strtotime($data->travel_date)) }}</td>
                                        <td class="table-data bordered-td" style="text-align: center;">{{ date('Y', strtotime($data->travel_date)) }}</td>
                                    </tr>
                                </table>
                            </td>
                            <td colspan="2" style="width: 30%" >&nbsp;</td>
